    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/catsupplier/{{$catSupplier->id}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="text" class="form-control" value="{{$catSupplier->tip_prove}}" id="abrecat" name="abrecat">
                        </div>                        
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="text" class="form-control" value="{{$catSupplier->descripcion}}" name="namecat" name="namecat">
                        </div>
                        <a href="/catsupplier">
