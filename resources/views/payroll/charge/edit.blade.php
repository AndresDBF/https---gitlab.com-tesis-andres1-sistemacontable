    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('chargesupdate',['idcarg' => $charge->idcarg]) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="text" class="form-control" id="concepto_cargo" value="{{$charge->concepto_cargo}}" name="concepto_cargo" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="number" class="form-control" id="sueldo_cargo" value="{{$charge->sueldo_cargo}}" name="sueldo_cargo" step="0.01" pattern="^\d+(\.\d{1,2})?$">
                        </div>
                        <a href="/payroll">
