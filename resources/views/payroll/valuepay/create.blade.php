                ...
                <div class="card-body">
                    <form action="{{ route('storevalue') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="text" class="form-control" id="concepto_valor" name="concepto_valor">
                        </div>                        
                        <div class="mb-3">
                            ...
                            @endif
                            <input type="number" class="form-control" id="monto_valor" name="monto_valor" step="0.01" pattern="^\d+(\.\d{1,2})?$">
                        </div>
